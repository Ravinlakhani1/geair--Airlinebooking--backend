        ...
        <div class="row justify-content-center">
            <div class="col-lg-7">
                <div class="fly-next-nav">
                    ...
                    <button class="" data-filter=".cat-one">Car Rentals <i
                            class="flaticon-car-1"></i></button>
                    <button class="" data-filter=".cat-two">Taxis <i
                            class="flaticon-taxi"></i></button>
                </div>
            </div>
        </div>
        <div class="row fly-next-active justify-content-center">
                ...
                <div class="fly-next-item">
                    <div class="fly-next-thumb">
                        <a href="booking-details.html"><img
                                src="{{ asset('assets/img/images/fly_img01.jpg') }}" alt=""></a>
                    </div>
                    <div class="fly-next-content">
                        ...
                        <a href="booking-details.html" class="air-logo"><img
                                src="{{ asset('assets/img/icon/fly_icon01.jpg') }}" alt=""></a>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 grid-item grid-sizer cat-one cat-two">
                <div class="fly-next-item">
                    <div class="fly-next-thumb">
                        <a href="booking-details.html"><img
                                src="{{ asset('assets/img/images/fly_img02.jpg') }}" alt=""></a>
                    </div>
                    <div class="fly-next-content">
                        <span>09 Jun 2022 - 16 Jun 2022</span>
                        ...
                        <h4 class="title">New York (USA)</h4>
                        <a href="booking-details.html" class="air-logo"><img
                                src="{{ asset('assets/img/icon/fly_icon02.jpg') }}" alt=""></a>
                        <div class="content-bottom">
                            <p>Business Class</p>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 grid-item grid-sizer cat-two">
                <div class="fly-next-item">
                    <div class="fly-next-thumb">
                        <a href="booking-details.html"><img
                                src="{{ asset('assets/img/images/fly_img03.jpg') }}" alt=""></a>
                    </div>
                    <div class="fly-next-content">
                        <span>09 Jun 2022 - 16 Jun 2022</span>
                        ...
                        <h4 class="title">New York (USA)</h4>
                        <a href="booking-details.html" class="air-logo"><img
                                src="{{ asset('assets/img/icon/fly_icon03.jpg') }}" alt=""></a>
                        <div class="content-bottom">
                            <p>Economy from</p>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 grid-item grid-sizer cat-one">
                <div class="fly-next-item">
                    <div class="fly-next-thumb">
                        <a href="booking-details.html"><img
                                src="{{ asset('assets/img/images/fly_img04.jpg') }}" alt=""></a>
                    </div>
                    <div class="fly-next-content">
                        <span>09 Jun 2022 - 16 Jun 2022</span>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 grid-item grid-sizer cat-two">
                <div class="fly-next-item">
                    <div class="fly-next-thumb">
                        <a href="booking-details.html"><img
                                src="{{ asset('assets/img/images/fly_img05.jpg') }}" alt=""></a>
                    </div>
                    <div class="fly-next-content">
                        <span>09 Jun 2022 - 16 Jun 2022</span>
                        <h4 class="title">Dubai (DXB)</h4>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 grid-item grid-sizer cat-one">
                <div class="fly-next-item">
                    <div class="fly-next-thumb">
                        <a href="booking-details.html"><img
                                src="{{ asset('assets/img/images/fly_img06.jpg') }}" alt=""></a>
                    </div>
                    <div class="fly-next-content">
                        <span>09 Jun 2022 - 16 Jun 2022</span>
                        <h4 class="title">Dubai (DXB)</h4>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 grid-item grid-sizer cat-two cat-one">
                <div class="fly-next-item">
                    <div class="fly-next-thumb">
                        <a href="booking-details.html"><img
                                src="{{ asset('assets/img/images/fly_img07.jpg') }}" alt=""></a>
                    </div>
                    <div class="fly-next-content">
                        <span>09 Jun 2022 - 16 Jun 2022</span>
                        <h4 class="title">Switzerland (SWL)</h4>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 grid-item grid-sizer cat-two">
                <div class="fly-next-item">
                    <div class="fly-next-thumb">
                        <a href="booking-details.html"><img
                                src="{{ asset('assets/img/images/fly_img08.jpg') }}" alt=""></a>
                    </div>
                    <div class="fly-next-content">
                        <span>09 Jun 2022 - 16 Jun 2022</span>
