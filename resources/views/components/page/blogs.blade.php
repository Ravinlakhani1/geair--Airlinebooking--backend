        ...
        <div class="row justify-content-center">
            <div class="col-53">
                <div class="blog-item">
                    <div class="blog-thumb">
                        <a href="blog-details.html"><img src="{{ asset('assets/img/blog/blog_img01.jpg') }}"
                                alt=""></a>
                    </div>
            ...
            <div class="col-47">
                <div class="blog-item small-item">
                    <div class="blog-thumb">
                        <a href="blog-details.html"><img src="{{ asset('assets/img/blog/blog_img02.jpg') }}"
                                alt=""></a>
                    </div>
                    <div class="blog-content">
                        <div class="blog-meta">
                ...
                <div class="blog-item small-item">
                    <div class="blog-thumb">
                        <a href="blog-details.html"><img src="{{ asset('assets/img/blog/blog_img03.jpg') }}"
                                alt=""></a>
                    </div>
                    <div class="blog-content">
                        <div class="blog-meta">
                ...
                <div class="blog-item small-item">
                    <div class="blog-thumb">
                        <a href="blog-details.html"><img src="{{ asset('assets/img/blog/blog_img04.jpg') }}"
                                alt=""></a>
                    </div>
                    <div class="blog-content">
                        <div class="blog-meta">
                        ...
                        <h2 class="title"><a href="blog-details.html">But There are Dozen of Low-cost
                                Airlines Including</a></h2>
                    </div>
                </div>
            </div>
        </div>
