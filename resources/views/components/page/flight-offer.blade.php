            ...
            <div class="col-lg-6 col-md-10">
                <div class="flight-offer-item">
                    <div class="flight-offer-thumb">
                        <img src="{{ asset('assets/img/images/offer_img01.jpg') }}" alt="">
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="flight-offer-item offer-item-two">
                            <div class="flight-offer-thumb">
                                <img src="{{ asset('assets/img/images/offer_img02.jpg') }}" alt="">
                            </div>
                            <div class="flight-offer-content">
                    ...
                    <div class="col-sm-6">
                        <div class="flight-offer-item offer-item-two">
                            <div class="flight-offer-thumb">
                                <img src="{{ asset('assets/img/images/offer_img03.jpg') }}" alt="">
                            </div>
                            <div class="flight-offer-content">
                    ...
                    <div class="col-sm-6">
                        <div class="flight-offer-item offer-item-two">
                            <div class="flight-offer-thumb">
                                <img src="{{ asset('assets/img/images/offer_img04.jpg') }}" alt="">
                            </div>
                            <div class="flight-offer-content">
                    ...
                    <div class="col-sm-6">
                        <div class="flight-offer-item offer-item-two">
                            <div class="flight-offer-thumb">
                                <img src="{{ asset('assets/img/images/offer_img05.jpg') }}" alt="">
                            </div>
                            <div class="flight-offer-content">
